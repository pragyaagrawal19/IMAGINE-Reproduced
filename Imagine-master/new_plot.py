...
def plot_all(path, trial):
    ...
    for k, ep in enumerate(steps):
        path1 = folder_path + '/' + 'goal_info' + '/'
        with open(path1 + 'info_' + '9900' + '.pk', 'rb') as f:
            data = pickle.load(f)
        #print(data['exploration_metrics'])
...
if __name__=="__main__":
    ...
    folder_path=r"C:\Users\pragy\Documents\Imagine-master\3633"
    os.chdir(folder_path)
    print(os.getcwd())
    for trial in os.listdir(folder_path  + '/'):
        #path = folder_path + '/' + trial + '/'
        #print(path)
        plot_all(folder_path, trial)
